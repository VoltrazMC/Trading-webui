        ...
        <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
            <m.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-blue-400 text-xs font-bold uppercase tracking-widest mb-6"
            >
        ...
        <section className="py-20 bg-black relative z-10">
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              ...
              <m.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="glass p-8 rounded-3xl hover:-translate-y-2 transition-transform duration-300">
